...
namespace GraphView
{
    ...
    public abstract class PropertyField : FieldObject
    {
        ...
        public override string ToValue => this.PropertyValue;
    ...
    public class AdjacencyListField : FieldObject
    {
        ...
        // used when all fetched edges are in the same document
        // when: add one new edge && spill edges for the first time 
        // because the new edge is not in the vertexCache, hence all fetched edges are in the same document
    ...
    public class VertexField : FieldObject
    {
        ...
        public override FieldObject this[string propertyName]
        {
            get
            {
                ...
                if (propertyName.Equals(DocumentDBKeywords.KW_TABLE_DEFAULT_COLUMN_NAME,
    ...
    public class RawRecord
    {
        ...
        {
            if (header.IndexOf(FieldName) == -1)
            {
                return null;
            }
            else if (fieldValues.Count <= header.IndexOf(FieldName))
            {
                return null;
            }
            else
            {
                return fieldValues[header.IndexOf(FieldName)];
            }
        }
