...
namespace GraphView
{
    ...
    #line 1 "D:\source\graphview\GraphView\DocDBDeleteNodeTemplate.tt"
    [global::System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.VisualStudio.TextTemplating", "12.0.0.0")]
    public partial class DocDBDeleteNodeTemplate : DocDBDeleteNodeTemplateBase
    {
#line hidden
        /// <summary>
...
namespace ConsoleApplication1
{
    ...
    public class Program
    {
        ...
        private const string EndpointUrl = """);
            ...
            #line 31 "D:\source\graphview\GraphView\DocDBDeleteNodeTemplate.tt"
            ...
            #line 32 "D:\source\graphview\GraphView\DocDBDeleteNodeTemplate.tt"
            ...
            #line 508 "D:\source\graphview\GraphView\DocDBDeleteNodeTemplate.tt"
            ...
            #line 517 "D:\source\graphview\GraphView\DocDBDeleteNodeTemplate.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(DatabaseID));
            ...
            #line 520 "D:\source\graphview\GraphView\DocDBDeleteNodeTemplate.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(DatabaseID));
            ...
            #line 526 "D:\source\graphview\GraphView\DocDBDeleteNodeTemplate.tt"
            ...
            #line 536 "D:\source\graphview\GraphView\DocDBDeleteNodeTemplate.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(CollectionID));
            ...
            #line 539 "D:\source\graphview\GraphView\DocDBDeleteNodeTemplate.tt"
            this.Write(this.ToStringHelper.ToStringWithCulture(DatabaseID));
            ...
            #line default
            #line hidden
            this.Write("\");\r\n            }\r\n\r\n\t\t\tvar sum_DeleteNode = client.CreateDocumentQuery(\"dbs/\" +" +
                    " database.Id + \"/colls/\" + documentCollection.Id,\r\n            \"SELECT * \" +\r\n  " +
                    "          \"FROM Node \" +\r\n\t\t\t");
            
            #line 545 "D:\source\graphview\GraphView\DocDBDeleteNodeTemplate.tt"
if(search == null)
			{
				Write(@"""WHERE ARRAY_LENGTH(Node._edge)>0 or ARRAY_LENGTH(Node._reverse_edge)>0 "" );");
			}
			else
			{
				Write(@"""WHERE " + search.ToString() + @" and (ARRAY_LENGTH(Node._edge)>0 or ARRAY_LENGTH(Node._reverse_edge)>0) "" );");
			}
            
            #line default
            #line hidden
            this.Write(@"			bool flag = true;
            ...
            if(flag)
            {
				sum_DeleteNode = client.CreateDocumentQuery(""dbs/"" + database.Id + ""/colls/"" + documentCollection.Id,
                ""SELECT * "" +
                ""FROM Node "" 
				");
            
            #line 564 "D:\source\graphview\GraphView\DocDBDeleteNodeTemplate.tt"
if (search != null)
                {
					Write(@"+
            ...
            #line hidden
            this.Write("                \r\n                foreach(var DeleteNode in sum_DeleteNode)\r\n\t\t\t\t" +
                    "\tawait Delete_Node(DeleteNode.id);\r\n\r\n\t\t\t}\r\n        }\r\n\r\n    }\r\n}");
    ...
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.VisualStudio.TextTemplating", "12.0.0.0")]
    public class DocDBDeleteNodeTemplateBase
    {
        #region Fields
