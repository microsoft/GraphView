            ...
            graph.g().Inject(0).Coalesce(
                ...
                GraphTraversal2.__()
                                ...
                                GraphTraversal2.__()
                                    ...
                                    .SideEffect(
                                        GraphTraversal2.__()
                                            ...
                                            .Property("name", "Sodamachineinstaller")
                                            .Property("kind", "property")
                                            .Property("type", "string"))
                                    .SideEffect(
                                        GraphTraversal2.__()
                    ...
                    .By(GraphTraversal2.__()
                        ...
                        .SideEffect(GraphTraversal2.__().Union(
                            GraphTraversal2.__().Property("_name", "UberSodaMachine"),
                            GraphTraversal2.__().SideEffect(
                                GraphTraversal2.__()
                                    .AddE("_val")
                                    .To(GraphTraversal2.__().AddV("_val").Property(
